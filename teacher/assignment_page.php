...
//answer readout
$answer = "<b>Correct Answer:</b> ".$getAssignment[$i]['answer1'];

$answer .= "<br><b>Wrong Answer:</b> ".$getAssignment[$i]['answer2'];
$answer .= "<br><b>Wrong Answer:</b> ".$getAssignment[$i]['answer3'];
$answer .= "<br><b>Wrong Answer:</b> ".$getAssignment[$i]['answer4'];
